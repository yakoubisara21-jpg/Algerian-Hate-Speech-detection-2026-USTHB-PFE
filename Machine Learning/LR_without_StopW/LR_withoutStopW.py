                ...
                for class_weight in param_grid['class_weight']:
                    ...
                    try:
                        ...
                        if gap <= MAX_GAP:
                            ...
                            # Optionnel : afficher les modèles rejetés à cause du gap
                            if val_acc > 0.80:  # Seulement pour les bons modèles rejetés
                                print(f"\n❌ Rejeté (gap trop grand): C={C}, Train={train_acc:.4f}, Val={val_acc:.4f}, Gap={gap:.4f} > {MAX_GAP:.2f}")
