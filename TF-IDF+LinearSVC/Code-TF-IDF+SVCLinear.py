...
class_report = classification_report(y_test, y_pred, target_names=['Non-Hate', 'Hate'], output_dict=True)
...
test_metrics = {
    ...
    # Non-Hate class metrics
    'Non-Hate Precision': class_report['Non-Hate']['precision'],
    'Non-Hate Recall': class_report['Non-Hate']['recall'],
    'Non-Hate F1-Score': class_report['Non-Hate']['f1-score'],
    'Non-Hate Support': class_report['Non-Hate']['support'],
    
    # Hate class metrics
    'Hate Precision': class_report['Hate']['precision'],
    'Hate Recall': class_report['Hate']['recall'],
    'Hate F1-Score': class_report['Hate']['f1-score'],
    'Hate Support': class_report['Hate']['support'],
    
    # Average metrics
    'Macro Avg Precision': class_report['macro avg']['precision'],
    'Macro Avg Recall': class_report['macro avg']['recall'],
    'Macro Avg F1-Score': class_report['macro avg']['f1-score'],
    'Weighted Avg Precision': class_report['weighted avg']['precision'],
    'Weighted Avg Recall': class_report['weighted avg']['recall'],
    'Weighted Avg F1-Score': class_report['weighted avg']['f1-score']
}
...
# Save test metrics to CSV (one row with all metrics including classification report)
test_metrics_df = pd.DataFrame([test_metrics])
test_metrics_df.to_csv('test_metrics.csv', index=False)
print("\nTest metrics with classification report saved to 'test_metrics.csv'")
