...
def _plot_kfold_metrics(df_full, df_plot, k_folds, title_suffix, save_path):
    ...
    FIX: noms de colonnes alignés avec ceux générés par la boucle d'agrégation
         (ex: 'train_loss_moy' et non 'perte_train_moy').
    """
...
def plot_final_metrics(history, save_path):
    ...
    axes[5].set_visible(False)
    plt.suptitle('Métriques d\'entraînement final - LSTM avec FastText entraînables',
