...
PLONGEMENTS ENTRAÎNABLES (Fine-tuning)
...
PLONGEMENTS ARAVEC (ENTRAÎNABLES)
"""
...
class AraVecEmbeddings:
    """Gestionnaire des plongements AraVec - ENTRAÎNABLES."""
...
class RNNTextClassifier(nn.Module):
    """
    Classifieur RNN unidirectionnel avec plongements AraVec ENTRAÎNABLES.
    ...
    def __init__(self, vocab_size, embedding_dim, hidden_dim, output_dim,
        ...
        if pretrained_embeddings is not None:
            ...
            print("Plongements AraVec ENTRAÎNABLES (fine-tuning actif)")
...
def run_kfold_best_params(all_texts, all_labels, vocab, embedding_tensor,
    ...
    # FIX: title_suffix argument ajouté (était manquant → TypeError)
...
def run_optuna(train_texts, train_labels, vocab, embedding_tensor,
    ...
    print("RNN UNIDIRECTIONNEL - PLONGEMENTS ENTRAÎNABLES (AraVec)")
...
def main():
    ...
    print("=" * 70)
    print("RNN avec plongements AraVec (entraînables) - Classification de texte avec OPTUNA")
    print("OBJECTIF OPTUNA: MAXIMISATION DU F1 DE VALIDATION")
    print("ÉPOQUE OPTIMALE MODÈLE FINAL: MIN PERTE VALIDATION (K-FOLD)")
    print(f"VALIDATION CROISÉE STRATIFIÉE K-FOLDS K={K_FOLDS}")
    print("RNN UNIDIRECTIONNEL - PLONGEMENTS ENTRAÎNABLES (AraVec)")
